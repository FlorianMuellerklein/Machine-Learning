...
class LinReg(object):
	...
	def transform(self, data):
		...
		"""
		why did you switch this? I originally wrote it this way
		and the blog does but I hate this way.
		No need to append indefinitely to .mean and .std
		when numpy will calculate mean and std across data.
